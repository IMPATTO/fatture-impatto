...
FROM (VALUES
  ...
  ('M1', NULL, NULL, 'Serena #1', '2026-07-10', '2026-07-20', 2, 'confirmed', 'pr-serena'),
  ('M4', NULL, NULL, 'Luca (estate)', '2026-07-13', '2026-08-17', 2, 'confirmed', 'pr-luca'),
  ...
  ('M2', NULL, NULL, 'Serena #2', '2026-07-20', '2026-07-27', 3, 'confirmed', 'pr-serena'),
  ('M3', NULL, NULL, 'Serena PR', '2026-07-20', '2026-07-27', 3, 'confirmed', 'pr-serena'),
  ...
  ('T1', NULL, NULL, 'Serena #3', '2026-08-10', '2026-08-20', 5, 'confirmed', 'pr-serena'),
